    ...
    <div className="pt-14">
      ...
      <div className="mt-20 px-5 w-full flex flex-col items-center">
        ...
        <p className="mt-5 leading-7">
          ...
          menghuni daerah selatan Provinsi Sumatera Utara. Mereka pernah berada
          di bawah pengaruh Kaum Padri dari Minangkabau, sehingga secara
          kultural etnis ini dipengaruhi oleh budaya agama Islam. Sebagian kecil
          etnis ini juga bermukim di Selangor dan Perak, Semenanjung Malaysia.
        </p>
