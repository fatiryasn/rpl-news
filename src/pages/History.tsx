    ...
    <div className="pt-14">
      ...
      <div className="mt-20 px-5 w-full flex flex-col">
        ...
        <p className="mt-3 leading-7">
          ...
          berarti "wilayah" atau "lingkaran kekuasaan", sedangkan Holing mengacu
          pada kerajaan kuno yang dikenal dalam catatan sejarah Nusantara.
          Gabungan ini menghasilkan makna "Wilayah Holing", menunjukkan
          kemungkinan pengaruh kerajaan Hindu-Buddha di masa lalu pada kawasan
          ini.
        </p>
        <h3 className="font-semibold font-poppins mt-5">
        ...
        <p className="mt-3 leading-7">
          Nama Mandailing juga mendapatkan perhatian selama periode Perang Padri
          (1803-1838). Dalam konflik ini, Mandailing sering disebut sebagai
          salah satu wilayah yang berada di bawah pengaruh budaya Minangkabau
          dan Islam. Beberapa sumber menyebutkan bahwa istilah Mandailing lebih
          sering digunakan setelah peperangan untuk merujuk pada identitas
        ...
        <p className="mt-3 leading-7">
          ...
          berasal dari bahasa Minangkabau yaitu Mandehiliang yang memiliki arti
          "Ibu yang hilang". Dari ini, terdapat fakta bahwa kedudukan seorang
          wanita terutama sosok ibu di Minangkabau benar-benar penting.
        </p>
        <h2 className="font-semibold text-xl font-poppins mt-16">
          Periode Kerajaan
        </h2>
        ...
        <p className="mt-3 leading-7">
          Islam menjadi agama utama di Mandailing pada masa kekuasaan Kaum Padri
          (1803–1837). Kaum Padri yang berasal dari Minangkabau membawa misi
          Islamisasi ke Mandailing. Perlawanan terhadap pengaruh Padri sempat
          terjadi, tetapi akhirnya masyarakat Mandailing menerima Islam sebagai
        ...
        <p className="mt-3 leading-7">
          Saat ini, masyarakat Batak Mandailing terus berkembang pesat meskipun
          tetap menjaga akar budaya dan tradisi mereka. Di Kabupaten Mandailing
          Natal, Sumatera Utara, suku Mandailing masih menjadi kelompok etnis
          utama, dengan nilai kekeluargaan yang kuat dan marga sebagai identitas
          sosial penting. Agama Islam, yang telah mempengaruhi budaya mereka
          sejak abad ke-17, menjadi bagian tak terpisahkan dari kehidupan
          sehari-hari.
        </p>
        <SectionController
