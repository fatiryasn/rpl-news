    ...
    <div className="pt-14">
      ...
      <div className="mt-20 px-5 w-full flex flex-col">
        ...
        <ul className="list-disc pl-5 mt-3">
          ...
          <li className="mt-2">
            <p>
              ...
              laki-laki. Bobat diselipkan di pinggang pada bagian luar. Di Bobat
              tersebut juga diselipkan pisau sebanyak dua pisau. Pisau tersebut
              adalah pisau jantan dan pisau betina, kedua pisau ini memiliki
              gagang yang berbeda. Pisau jantan diselipkan di sebelah kanan dan
              pisau betina di sebelah kiri.
            </p>
          </li>
          <li className="mt-2">
            <span>
              Sarung Songket: Dipakai di pinggang hingga lutut, memberikan kesan
              elegan.
            </span>
            <div className="flex items-center gap-4">
              <img
        ...
        <ul className="list-disc pl-5 mt-3">
          ...
          <li className="mt-2">
            <span>
              Selendang Ulos: Dililitkan di bahu atau digunakan sebagai penutup
              kepala.
            </span>
          </li>
          <li className="mt-2">
            <span>
              Kalung emas: Disematkan di atas bahan kain beludru berwarna hitam.
            </span>
          </li>
          <li className="mt-2">
          ...
          <li className="mt-2">
            <span>
              Sepasang keris yang berukuran kecil. Keris ini diselipkan di ikat
              pinggang di bagian depan.
            </span>
          </li>
        </ul>
        ...
        <ol className="list-decimal pl-5 mt-5">
          <li>
            ...
            <p>
              ...
              sosial keluarga kedua mempelai. Penggunaan kain ulos tertentu juga
              menyimbolkan doa dan restu.
            </p>
          </li>
          <li className="mt-2">
            <h3 className="font-poppins text-lg font-semibold">Upacara Adat</h3>
            <p>
