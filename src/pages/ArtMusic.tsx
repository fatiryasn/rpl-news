    ...
    <div className="pt-14">
      ...
      <div className="mt-20 px-5 w-full flex flex-col">
        ...
        <p className="mt-3 leading-7">
          ...
          akan kekayaan budaya Indonesia yang beragam. Dari dentingan alat musik
          Gordang Sambilan hingga tarian Tor-tor yang anggun, seni Mandailing
          merefleksikan harmoni dan kearifan lokal yang diwariskan oleh leluhur.
        </p>
        ...
        <div className="text-sm">
          <p className="mt-3">
            ...
            <br /> Manjalaki parabiton mi <br /> Bope na dalan marutang, hubaen
            doi amang <br /> Asalkon ma na jadi sikolah mi
          </p>
          <p className="mt-3">
            Manangkok dohot manuat, hutaon doi inang <br /> Manjalaki hangoluan
            on <br />
            Bope na maridi hodok, hutaon doi inang <br /> Asalkon ma na lalu
            sikolah mi <br />
          </p>
          <p className="mt-3">
            Hari margonti bulan, bulan margonti taon <br /> Hari margonti bulan,
            bulan margonti taon <br /> Pasikolahon pe mur ma bahat <br /> Umur
            pe mur matobang
          </p>
          <p className="mt-3">
            Tai nung sannari, ho nung ma gabe <br /> Hami pe inda di ingot ho be{" "}
            <br /> Tai dung sannari ho nung ma gabe <br />
            Hami pe inda di ingot ko be
          </p>
          <p className="mt-3">
            Holong ni orang tua, imada tu anak na <br />
            Sadalalam ni lautan, salembut ni sutra <br /> Inda jungada mandokkon
            loja <br /> Inda jungada mangido upah <br /> Asalkon ma baya <br />{" "}
            Anakki mar bahagia <br /> Asalkon ma baya Anakki mar bahagia
          </p>
          <p className="mt-3">
            Marudan marlasniari hutaon doi amang <br /> Manjalaki parabiton mi{" "}
            <br /> Bope na dalan marutang, hubaen doi amang <br /> Asalkon ma na
            jadi sikolah mi
          </p>
        </div>
        <h2 className="font-semibold text-xl font-poppins mt-16">
        ...
        <p className="mt-3 leading-7">
          Setiap daerah punya jenis tariannya masing-masing. Salah satunya etnis
          Mandailing. Mandailing punya beberapa tarian khas yang sering
          dipertunjukkan dalam berbagai upacara dan kegiatan adat di masyarakat.
        </p>
        ...
        <p className="mt-3 leading-7">
          ...
          Sibaso, yang seolah-olah seperti meminta bantuan atau pertolongan pada
          begu (roh-roh halus) untuk mengabulkan permohonannya. Jenis tarian ini
          sering dipakai saat terjadi banyak musibah. Misalnya saja seperti
          hujan terus menerus, kekeringan, dan juga penyakit menular. Dari
          kepercayaan masyarakat setempat, hanya Sibasolah yang bisa
        ...
        <p className="mt-3 leading-7">
          Pada tarian ini, biasanya diperuntukkan sebagai tari persembahan pada
          upacara perkawinan. Dengan nama upacara Horja Godang Haroan Boru. Kita
          bisa mengartikannya sebagai datangnya pengantin yang akan
          menikah.Tarian tor-tor tepak ini dilakukan pada malam hari dan digelar
          selama 3 hari. Ketika ingin melakukan tarian, para penari menggunakan
          pakaian khas Mandailing dengan aksesoris di bagian kepala.
        </p>
